...
def index(request):
    ...
    context = {
        ...
        'type6': type6, 'type11': type11, 'type22': type22, 'type33': type33,
        'type44': type44, 'type55': type55, 'type66': type66}
...
def detail(request, id1, id2):
    ...
    if goods_ids != '':
        ...
        response.set_cookie('goods_ids', goods_ids,max_age=60*60*24)
        return response
    else:
