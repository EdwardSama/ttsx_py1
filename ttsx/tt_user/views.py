...
from . import task
from tt_goods.models import GoodsInfo,TypeInfo
...
def info(request):
    ...
    if goods_ids != '':
        ...
        for goods_id in goods_ids1:
            glist.append(GoodsInfo.objects.get(id=int(goods_id)))
    ...
    try:
        ...
        context = {'email': email, 'uname': uname, 'addr': '尚未填写','glist': glist}
        return render(request, 'tt_user/user_center_info.html', context)
